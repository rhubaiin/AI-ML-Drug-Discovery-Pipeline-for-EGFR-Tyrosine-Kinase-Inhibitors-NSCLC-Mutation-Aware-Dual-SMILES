...
# =============================================================================
# DATA LOADING  (script_dir now defined — Bug 2 fixed)
# =============================================================================
print("\nLoading datasets...")
...
def keras_main():
    ...
    for profile_idx, profile_row in unique_mutation_profiles.iterrows():
        ...
        for site_idx, (site_name, _) in enumerate(mutation_sites):
            ...
            mut_inter_feat = generate_mut_inter_features(mut_smi_site)
            mut_intra_feat = generate_mut_intra_features(mut_smi_site)
