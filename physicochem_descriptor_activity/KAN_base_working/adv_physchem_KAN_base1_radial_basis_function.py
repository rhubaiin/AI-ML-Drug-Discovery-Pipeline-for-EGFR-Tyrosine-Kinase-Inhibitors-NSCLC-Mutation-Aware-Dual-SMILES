...
#Assumptions:
# 1. Radial basis function gradients has significant feature capture capability for advanced physicochemical descriptors
...
def build_rnn_sequential_model(embedding_dim, n_timesteps=6):
    ...
    # KAN Layer 1 (TimeDistributed-like KAN)
    kan_out1 = KANLayer(out_features=128, name='kan_1')(gru_out1)
    
    # BiGRU 2
    gru_out2 = Bidirectional(GRU(64, return_sequences=False, dropout=0.2))(kan_out1)
    
    # KAN Layer 2
    kan_out2 = KANLayer(out_features=128, name='kan_2')(gru_out2)
    ...
    x = KANLayer(out_features=128, name='final_merged_kan')(combined)
    x = BatchNormalization()(x)
    x = Dropout(0.3)(x)
