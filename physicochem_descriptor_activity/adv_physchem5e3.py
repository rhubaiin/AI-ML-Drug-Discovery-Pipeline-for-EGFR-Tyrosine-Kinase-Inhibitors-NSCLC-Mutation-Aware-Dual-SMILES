...
# === Load Data ===
print("\nLoading datasets...")
df_train = pd.read_csv('/mnt/d/Publications/project_insilico/activity_physicochem_descriptor/df_combo_tki_ed_smiles_lig_activity_validated.csv')
...
def generate_hierarchical_features(ligand_smiles_series, mutation_smiles_series):
    ...
    # Initialize caches to store features for unique molecules and pairs
    ligand_cache = {}
    mutation_cache = {}
    interaction_cache = {}
...
def main():
    ...
    for site_idx, (site_name, _) in enumerate(mutation_sites):
        ...
        with open(f'scalers_{site_name}.pkl', 'wb') as f:
            pickle.dump(scalers, f)
        print(f"Saved scalers for {site_name}")
    ...
    print("Saved y_scaler for predictions")
